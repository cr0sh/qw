...
#[tokio::test]
async fn image_inputs_are_rejected_by_both_openai_endpoints() {
    let app = router(Engine::start_fake(Some(MODEL), 8));
    let cases = [
        (
            "/v1/chat/completions",
