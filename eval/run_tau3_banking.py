...
def main() -> int:
    ...
    config = TaskConfig(
        ...
        dataset_args={
            "tau3_bench": {
                ...
                "extra_params": {
                    "user_model": "deepseek-v4.1-flash",
    ...
    print("simulator_and_nl_judge=deepseek-v4.1-flash endpoint=https://api.deepseek.com thinking=disabled temperature=0", flush=True)
